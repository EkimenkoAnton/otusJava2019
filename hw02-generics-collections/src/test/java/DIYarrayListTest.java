...
class DIYarrayListTest {
    ...
    void addAll() {
        ...
        Assertions.assertEquals(list.size(),arr.length);
        Assertions.assertTrue(Arrays.asList(arr).equals(list));
    }
    ...
    void copy() {
        ...
        Assertions.assertTrue(srcList.equals(trgList));
    }
    ...
    void sort() {
        ...
        Assertions.assertTrue(expectedList.equals(list));
    }
